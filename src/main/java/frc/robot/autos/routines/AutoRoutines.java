...
public class AutoRoutines {
    ...
    public static Command ampWing1Note(
            ...
            PivotIntake pivotIntake) { // This is an example on how to make a choreo auto, I have no clue if its
        // gonna work
        return Commands.sequence(
                swerve
                        ...
                        Commands.sequence(
                                ...
                                Commands.either(
                                        ...
                                        Commands.sequence(
                                                ...
                                                AutoHelperCommands.shootSubwoofer(
                                                        intake, shooter, swerve, pivotShooter, c3_center,
                                                        noteOuttaken)),
                                        intake::isBeamBroken)),
                        intake::isBeamBroken));
    }

    public static Command diagSweep(Intake intake, Shooter shooter, CommandSwerveDrivetrain swerve,
            PivotShooter pivotShooter, PivotIntake pivotIntake) {
