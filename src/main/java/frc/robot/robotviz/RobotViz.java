...
public class RobotViz {
    ...
    public RobotViz(
        ...
        // left climb
        MechanismLigament2d leftClimbRoot = robotRoot.append(
                new MechanismLigament2d("Climb Left Root", kClimberX, 0, kLineWidth, orange));
        MechanismLigament2d leftClimbSpout = leftClimbRoot.append(
                new MechanismLigament2d("Climb Left Spout", kClimberSpoutHeight, 90, kLineWidth, blue));
        leftClimb = leftClimbSpout.append(new MechanismLigament2d("Climb Left", 0.05, 0, kLineWidth, green));
        // right climb
        MechanismLigament2d rightClimbRoot = robotRoot.append(
                new MechanismLigament2d(
                        "Climb Right Root", kClimberX + kClimberSpacing, 0, kLineWidth, orange));
        MechanismLigament2d rightClimbSpout = rightClimbRoot.append(
                new MechanismLigament2d(
                        "Climb Right Spout", kClimberSpoutHeight, 90, kLineWidth, blue));
        rightClimb = rightClimbSpout.append(new MechanismLigament2d("Climb Right", 0.05, 0, kLineWidth, green));
        // shooter
        MechanismLigament2d shooterRoot = robotRoot
                .append(new MechanismLigament2d("Shooter Root", shooterX, 0, kLineWidth, orange));
        MechanismLigament2d shooterSpout = shooterRoot.append(
                new MechanismLigament2d(
                        "Shooter Spout", shooterOffset, shooterAngle.getDegrees(), kLineWidth, red));
        shooter = shooterSpout.append(
                new MechanismLigament2d("Shooter", shooterRadius, 90, kLineWidth, green));
        // feeder
        MechanismLigament2d feederSpout = shooterRoot.append(
                new MechanismLigament2d(
                        "Feeder Spout", feederOffset, shooterAngle.getDegrees(), kLineWidth, red));
        feeder = feederSpout.append(new MechanismLigament2d("Feeder", feederRadius, 90, kLineWidth, green));
        // arm
        MechanismLigament2d pivotRoot = robotRoot
                .append(new MechanismLigament2d("Pivot Root", armX, 0, kLineWidth, orange));
        MechanismLigament2d pivotRootSpout = pivotRoot
                .append(new MechanismLigament2d("Pivot Root Spout", armY, 90, kLineWidth, blue));
        pivot = pivotRootSpout.append(new MechanismLigament2d("Pivot", armLength, 0, kLineWidth, white));
        MechanismLigament2d hand = pivot.append(new MechanismLigament2d("Hand", handLength, 90, kLineWidth, white));
        // intake
