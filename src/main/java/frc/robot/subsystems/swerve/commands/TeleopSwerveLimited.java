...
public class TeleopSwerveLimited extends DebugCommandBase {
  ...
  public void execute() {
    ...
    if (kQuadraticDrive) {
      swerveDrive.drive(
          new Translation2d(
              SwerveDrive.joystickToSpeed(translationVal, SwerveConstants.slowMaxAngularVelocity),
              SwerveDrive.joystickToSpeed(strafeVal, SwerveConstants.slowMaxTranslationalVelocity)),
          SwerveDrive.joystickToSpeed(rotationVal, SwerveConstants.slowMaxAngularVelocity),
          true,
          true);
    } else {
      swerveDrive.drive(
