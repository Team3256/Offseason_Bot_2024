...
public class IntakeIOTalonFX implements IntakeIO {
    ...
    public IntakeIOTalonFX() {
        ...
        motorConfig.MotionMagic.MotionMagicAcceleration = IntakeConstants.kIntakeMotionMagicAcceleration;
        ...
        PhoenixUtil.checkErrorAndRetry(() -> passthroughMotor.getConfigurator().refresh(passthroughConfig));
        ...
        motorConfig.MotionMagic.MotionMagicAcceleration = IntakeConstants.kPassthroughMotionMagicAcceleration;
        motorConfig.MotionMagic.MotionMagicCruiseVelocity = IntakeConstants.kPassthroughMotionMagicVelocity;
        motorConfig.MotionMagic.MotionMagicJerk = IntakeConstants.kPassthroughMotionMagicJerk;
        motorConfig.CurrentLimits.StatorCurrentLimitEnable = IntakeConstants.kPassthroughCurrentLimitEnable;
        ...
        BaseStatusSignal.setUpdateFrequencyForAll(IntakeConstants.updateFrequency,
                intakeMotorVoltage, 
                intakeMotorVelocity, 
