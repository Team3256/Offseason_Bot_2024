...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    if (FeatureFlags.kSwerveEnabled) {
      ...
      test.leftTrigger().onTrue(drivetrain.applyRequest(()->azi.withTargetDirection(Rotation2d.fromDegrees(180))));
...
//    driver.rightTrigger().whileTrue(intake.intakeIn());
  ...
  private void configurePivotIntake() {
    ...
    operator.povRight().onTrue(pivotIntake.setPosition(kPivotGroundPos * PivotIntakeConstants.kPivotMotorGearing));
