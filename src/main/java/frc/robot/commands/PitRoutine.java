...
public class PitRoutine extends DebugCommandBase {
  ...
  public void initialize() {
    ...
    if (Constants.FeatureFlags.kPivotIntakeEnabled) {
      Command pivotDown = pivot.setPosition(PivotIntakeConstants.kPivotGroundPos).withTimeout(0.75);
      Command pivotSlam = pivot.slamAndPID();
    ...
    if (Constants.FeatureFlags.kIntakeEnabled
        && Constants.FeatureFlags.kPivotIntakeEnabled
