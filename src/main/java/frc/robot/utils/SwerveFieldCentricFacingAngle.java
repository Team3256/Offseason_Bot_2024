...
public class SwerveFieldCentricFacingAngle implements SwerveRequest {
     ...
     * @return this request
     */
    public SwerveFieldCentricFacingAngle withDriveRequestType(SwerveModule.DriveRequestType driveRequestType) {
     ...
     * @return this request
     */
    public SwerveFieldCentricFacingAngle withSteerRequestType(SwerveModule.SteerRequestType steerRequestType) {
        this.SteerRequestType = steerRequestType;
        return this;
    }

    public SwerveFieldCentricFacingAngle withHeadingController(PhoenixPIDController headingController) {
