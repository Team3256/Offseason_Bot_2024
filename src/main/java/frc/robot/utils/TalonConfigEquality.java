...
public class TalonConfigEquality {
  ...
  public static boolean isEqual(Slot0Configs a, Slot0Configs b) {
    boolean val =
        Util.epsilonEquals(a.kP, b.kP, TALON_CONFIG_EPSILON)
  ...
  public static boolean isEqual(MotorOutputConfigs a, MotorOutputConfigs b) {
    boolean val =
        a.Inverted.value == b.Inverted.value
            ...
            && Util.epsilonEquals(
                a.PeakForwardDutyCycle, b.PeakForwardDutyCycle, TALON_CONFIG_EPSILON)
            && Util.epsilonEquals(
  ...
  public static boolean isEqual(CurrentLimitsConfigs a, CurrentLimitsConfigs b) {
    boolean val =
        Util.epsilonEquals(a.StatorCurrentLimit, b.StatorCurrentLimit, TALON_CONFIG_EPSILON)
  ...
  public static boolean isEqual(FeedbackConfigs a, FeedbackConfigs b) {
    boolean val =
        Util.epsilonEquals(a.FeedbackRotorOffset, b.FeedbackRotorOffset, TALON_CONFIG_EPSILON)
            && Util.epsilonEquals(
  ...
  public static boolean isEqual(MotionMagicConfigs a, MotionMagicConfigs b) {
    boolean val =
        Util.epsilonEquals(
                a.MotionMagicAcceleration, b.MotionMagicAcceleration, TALON_CONFIG_EPSILON)
            && Util.epsilonEquals(
