...
public class SinglePositionSubsystem extends SubsystemBase implements Loggable {
 ...
 public SinglePositionSubsystem(boolean isMotionMagic, double currentThreshold, double stallVelocity) {
 ...
 protected void configureRealHardware(int motorID, NeutralModeValue neutralModeValue, double kS, double kV, double kP, double kI, double kD, double velocity, double acceleration, double jerk, boolean enableStatorLimit, double statorLimit) {
 ...
 public void configureSimHardware(int kNumPositionMotors, double kPositionMotorGearing, double jKgMetersSquared, double kPositionLength, double kPositionMinAngleDeg, double kPositionMaxAngleDeg, boolean simulateGravity) {
